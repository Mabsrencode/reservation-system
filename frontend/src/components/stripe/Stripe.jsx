...
const Stripe = ({selectedTime, selectedDate, vehiclePrice, onToken, accessToken}) => {
  return (
    <StripeCheckout
                ...
                >
                    <Button className='mt-4' disabled={!selectedTime || !selectedDate || !vehiclePrice ? true : false}>
