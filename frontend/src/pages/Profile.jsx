        ...
        {bookings && bookings.map((booking) => (
            <div key={booking._id} className="bg-white overflow-hidden shadow rounded-lg border mt-6 mb-6">
                ...
                {booking.status === 'cancelled' ? <div className="text-right mx-2 my-2">
                    <Button onClick={() => { handleDelete(booking._id) }}>{loading ? <><svg aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
